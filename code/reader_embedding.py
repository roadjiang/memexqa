...
class DataSet(object):
  ...
  def __init__(self, infile, max_input_window_size = 12):
    ...
    #flat Gs
    self._data["Gs"] = utils.flat_arrays(self._data["Gs"])
    self._data["ATs"] = utils.flat_arrays(self._data["ATs"])
    self._data["PTs"] = utils.flat_arrays(self._data["PTs"])

    self._data["Qs"], self._data["Qs_l"] = utils.pad_input(self._data["Qs"], max_input_window_size, self._end_token_id)
    ...
    self._data["Is"], self._data["Is_l"] = utils.pad_input(self._data["Is"], max_input_window_size, self._end_token_id)

    
    self._data["ATs"], self._data["ATs_l"] = utils.pad_input(self._data["ATs"], max_input_window_size, self._end_token_id)
    self._data["PTs"], self._data["PTs_l"] = utils.pad_input(self._data["PTs"], max_input_window_size, self._end_token_id)

    
    self._modalities = ["qids", "labels", "As", "Qs", "Is", "Ts", "Gs", "PTs", "ATs", "Qs_l", "Is_l", "PTs_l"]
